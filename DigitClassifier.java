...
public class DigitClassifier {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 6) {
            System.out.println("usage: java DigitClassifier <noHiddenNode> <learningRate> <maxEpoch> <randomSeed> <trainFile> <testFile>");
            System.exit(-1);
        }
        ...
        for (int i = 0; i < testSet.size(); i++) {
            ...
            if (outputs[i] == actual_idx)
                ...
                System.out.println(i + "th instance got misclassified, expected: " + digits[actual_idx] + ". But actual: " + digits[outputs[i]]);
        }
